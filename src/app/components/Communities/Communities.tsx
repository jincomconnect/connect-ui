                    ...
                    {community.isAdmin && (
                      <Tooltip.Root>
                        <Tooltip.Trigger asChild>
                          <span className="absolute -bottom-1.5 -right-1.5 w-5 h-5 bg-neutral-900 rounded-full flex items-center justify-center border-2 border-white cursor-default">
