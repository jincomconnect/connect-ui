                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex items-center gap-3 mt-4">
                        <Tooltip.Root>
                          <Tooltip.Trigger asChild>
                            <div className="flex items-center gap-1.5 cursor-default">
                              ...
                              <span className="text-sm font-semibold text-neutral-900">{mockUserCommunities.length}</span>
                            </div>
                          </Tooltip.Trigger>
                          <Tooltip.Portal>
                            <Tooltip.Content className="bg-neutral-900 text-white text-xs px-2.5 py-1.5 rounded-lg font-medium shadow-lg z-50" sideOffset={5}>
                              Communities joined
                        ...
                        <Tooltip.Root>
                          <Tooltip.Trigger asChild>
                            <div className="flex items-center gap-1.5 cursor-default">
                              <svg viewBox="0 0 512 462.24" width="14" height="14" fill="currentColor" className="text-neutral-400" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd">
                              ...
                              <span className="text-sm font-semibold text-neutral-900">{mockUserCommunities.filter(c => c.isAdmin).length}</span>
                            </div>
                          </Tooltip.Trigger>
                          <Tooltip.Portal>
                            <Tooltip.Content className="bg-neutral-900 text-white text-xs px-2.5 py-1.5 rounded-lg font-medium shadow-lg z-50" sideOffset={5}>
                        ...
                        <Tooltip.Root>
                          <Tooltip.Trigger asChild>
                            <div className="flex items-center gap-1.5 cursor-default">
                              ...
                              <span className="text-sm font-semibold text-neutral-900">{mockUserCommunities.filter(c => c.isCreator).length}</span>
                            </div>
                          </Tooltip.Trigger>
                          <Tooltip.Portal>
                            <Tooltip.Content className="bg-neutral-900 text-white text-xs px-2.5 py-1.5 rounded-lg font-medium shadow-lg z-50" sideOffset={5}>
